...
// const BrandedFacts = () => {
//   return (
//     <section className="relative overflow-hidden bg-foreground px-8 py-24">
...
//       <span className="absolute -right-8 top-1/2 -translate-y-1/2 text-[18vw] font-serif font-bold text-white/ leading-none select-none pointer-events-none uppercase">
//         Facts
//       </span>
...
//           {/* Divider */}
//           <div className="h-px bg-linear-to-r from-primary/40 via-white/10 to-transparent mb-16" />

//           {/* Facts */}
//           <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-white/6 rounded-md overflow-hidden">
//             {facts.map((fact, index) => (
//               <div
//                 key={fact.label}
//                 className="group relative bg-foreground p-10 flex flex-col gap-7 hover:bg-white/4 transition-colors duration-500"
//                 style={{ animationDelay: `${index * 100}ms` }}
//               >
//                 {/* Top linear wash on hover */}
//                 <div
...
//                   <span className="text-5xl font-bold font-serif text-white/10 group-hover:text-white/20 transition-colors duration-300 leading-none">
//                     {fact.number}
//                   </span>
//                   <div
//                     className={`flex items-center justify-center w-11 h-11 rounded-full ${fact.iconBg} group-hover:text-white transition-all duration-300`}
//                   >
//                     {fact.icon}
//                   </div>
//                 </div>
...
//                 {/* Stat */}
//                 <div>
//                   <p className="text-5xl lg:text-6xl font-bold font-serif linear-text leading-none mb-1">
//                     {fact.stat}
//                   </p>
...
//                 {/* Label pill */}
//                 <span className="inline-flex self-start items-center px-3 py-1 rounded-full border border-white/10 text-xs font-semibold text-white/50 uppercase tracking-widest">
//                   {fact.label}
//                 </span>
