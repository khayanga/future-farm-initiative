...
// const TeamSection = () => {
//   return (
//     <section className="px-6 lg:px-12 py-20 bg-muted/30 mx-auto relative overflow-hidden">
...
//               We believe Africa’s farms must be designed for the future,
//               resilient, efficient, and productive. Our role is to enable the
//               creation of farm systems that integrate technology, sustainability,
//               and local context to enable farmers and agribusinesses to thrive
...
//                 {/* FIXED BUTTON */}
//                 <Button asChild variant="outline" size="lg" className="border border-primary text-md text-primary">
//                   <a
...
//             {/* FIX: pointer-events-none */}
//             <div className="absolute -inset-6 bg-primary/10 blur-3xl rounded-2xl pointer-events-none" />

//             <div className="relative w-full h-100 md:h-187.5 lg:h-full rounded-2xl overflow-hidden shadow-xl">
      ...
      <div className="container px-6 lg:px-12 mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-stretch">
          ...
          <div className="relative">
            ...
            <div className="relative w-full h-100 md:h-150 lg:h-full min-h-100 rounded-2xl overflow-hidden shadow-xl">
              <Image
                src="/team.jpg"
                alt="Future Farms Initiative Team"
                fill
